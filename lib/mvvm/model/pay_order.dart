...
class OrderPayed {
    ...
    factory OrderPayed.fromRawJson(String str) => OrderPayed.fromJson(json.decode(str));
...
class DataOrderPay {
    ...
    factory DataOrderPay.fromRawJson(String str) => DataOrderPay.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory DataOrderPay.fromJson(Map<String, dynamic> json) => DataOrderPay(
        items: json["items"] == null ? [] : List<DataItemPayOrder>.from(json["items"]!.map((x) => DataItemPayOrder.fromJson(x))),
        total: json["total"],
...
class DataItemPayOrder {
    ...
    factory DataItemPayOrder.fromRawJson(String str) => DataItemPayOrder.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory DataItemPayOrder.fromJson(Map<String, dynamic> json) => DataItemPayOrder(
...
class ItemItemOrder {
    ...
    factory ItemItemOrder.fromRawJson(String str) => ItemItemOrder.fromJson(json.decode(str));
